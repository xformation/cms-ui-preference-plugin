    ...
    render() {
        ...
        return (
            <div className="info-container">
                ...
                <button className="btn btn-primary m-1" onClick={e => this.showModal(e, true)} style={{width: '188px'}}>
                    <i className="fa fa-plus-circle"></i> Create New Permission
                </button>
                <button className="btn btn-primary m-1" style={{width: '140px'}}>Search Permission</button>
                            ...
                            <div className="modal-fwidth">
                                <div className="mdflex modal-fwidth">
                                    ...
                                    <div className="fwidth-modal-text">
                                        <label className="gf-form-label b-0 bg-transparent">PERMISSION</label>
                                        <select className="gf-form-input" >
                                            <option value="">
                                                Select
                                            </option>
                                ...
                                <div className="fwidth-modal-text">
                                    <label className="gf-form-label b-0 bg-transparent">DESCRIPTION</label>
