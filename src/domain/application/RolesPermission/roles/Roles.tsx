    ...
    render() {
        ...
        return (
            <div className="info-container">
                ...
                <button className="btn btn-primary" onClick={e => this.showModal(e, true)} style={{width: '160px'}}>
                    <i className="fa fa-plus-circle"></i> Create New Role
                </button>
                ...
                <div className="border FirstRow p-1">
                <div className="m-t-1 text-center">
                <button type="submit" className="btn btn-success border-bottom m-1">APPLY</button>     
