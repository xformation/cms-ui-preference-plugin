  ...
  render() {
    ...
    return (
      <div className="info-container roles-main-container">
        ...
        <div className="roles-container p-1 p-t-0 border-container" style={{border:'1px solid'}}>
          {
          ...
          {/* </div> */}
          <div className="m-b-1">
            <button className="btn btn-primary pull-right" onClick={e => this.showModal(e, true)} style={{width: '160px'}} >
                  ...
                  }
                  {
                    ...
                    <div className="mdflex modal-fwidth">
                      <div className="fwidth-modal-text m-r-1 fwidth">
                        <label className="gf-form-label b-0 bg-transparent">Role Name</label>
                    ...
                    <div className="fwidth-modal-text modal-fwidth">
                      <div className="fwidth-modal-text m-r-1 fwidth">
                        <label className="gf-form-label b-0 bg-transparent"> Role Description </label>
                    ...
                    <div className="m-t-1 text-center">
                      <button type="button" onClick={this.saveRole} className="btn btn-primary border-bottom mr-1"> Save </button>
        ...
        <div className="transition-preference">
          ...
          <div className="border-container p-1" style={{height:'200px', overflowY:'auto', border:'1px solid'}}>
            ...
            <div className="m-t-1 pull-right">
              <button type="button" onClick={this.updateRole} className="btn btn-primary border-bottom mr-1"> APPLY </button>
