      ...
      <div className="info-container">
        <div className="border p-1 pb-2">
          <div className="m-b-1" style={{float: 'right'}}>
            <button className="btn btn-primary mr-1" onClick={e => this.showImport(e, true)} style={{width: '120px'}} >
              <i className="fa fa-plus-circle" /> Import User
            </button>
            <button className="btn btn-primary mr-1" onClick={e => this.showModal(e, true)} style={{width: '110px'}} >
              <i className="fa fa-plus-circle" /> Add User
            </button>
            <button className="btn btn-primary mr-1" onClick={e => this.showEditModal(e, true, selectedUser)} disabled={selectedUser === null ? true : false } style={{width: '100px'}}>
              Edit User
            </button>
            <button className="btn btn-primary mr-1" onClick={e => this.showAssign(e, true)} style={{width: '130px'}} >
              <i className="fa fa-plus-circle" /> Assign Group
            </button>
            <input type="text" placeholder="search user" name="searchUser" onChange={this.onSearchUser} value={searchUser}/>
          </div>
              ...
              <form className="gf-form-group section m-0 dflex">
                <div className="fwidth-modal-text fwidth m-r-1">
                  ...
                  <div className="m-t-1 text-center">
                    <button type="button" onClick={this.importUser} className="btn btn-primary border-bottom mr-1" > Import </button>
                    <button className="btn btn-danger border-bottom mr-1" onClick={e => this.showImport(e, false)} > Cancel </button>
                  </div>
            ...
            <ModalBody className="modal-content">
              <form className="gf-form-group section m-0 dflex">
                <div className="modal-fwidth">
                  ...
                  <div className="mdflex modal-fwidth">
                    <div className="fwidth-modal-text fwidth m-r-1">
                      <label className="gf-form-label b-0 bg-transparent">Login Id </label>
                  ...
                  <div className="m-t-1 text-center">
                    <button type="button" className="btn btn-primary border-bottom mr-1" onClick={this.saveUser}> Save </button>
                    <button className="btn btn-danger border-bottom mr-1" onClick={e => this.showModal(e, false)} > Cancel </button>
                  </div>
                </div>
              </form>
            </ModalBody>
            ...
            <ModalBody className="modal-content">
              <form className="gf-form-group section m-0 dflex">
                <div className="modal-fwidth">
                  ...
                  <div className="m-t-1 text-center">
                    <button type="button" className="btn btn-primary border-bottom mr-1" onClick={this.updateUser}> Save </button>
                    <button className="btn btn-danger border-bottom mr-1" onClick={e => this.showEditModal(e, false, null)} > Cancel </button>
                  </div>
                </div>
              </form>
            </ModalBody>
          ...
          <Modal isOpen={isAssignRole} className="react-strap-modal-container">
            <ModalHeader>Assign Groups To Selected User</ModalHeader>
            <ModalBody className="modal-content">
            <form className="gf-form-group section m-0 dflex">
                <div className="modal-fwidth">
                  {
                  ...
                  <div className="m-t-1 text-center">
                    ...
                    <button type="button" onClick={this.assignSelectedGroupRolesToSelectedUser} disabled={selectedAssignUser === null ? true : false } className="btn btn-primary border-bottom mr-1"> Save </button>
