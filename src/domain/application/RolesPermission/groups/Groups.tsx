      ...
      <div className="info-container">
        <div className="border p-1 pb-2">
          <div className="m-b-1" style={{float: 'right'}}>
            <button className="btn btn-primary mr-1" onClick={e => this.showModal(e, true)} style={{width: '160px'}} >
            ...
            <input type="text" placeholder="search group" name="searchGroup" onChange={this.onSearchGroup} value={searchGroup}/>
          </div>
              ...
              <form className="gf-form-group section m-0 dflex">
                <div className="modal-fwidth">
                  ...
                  <div className="m-t-1 text-center">
                    <button type="button" className="btn btn-primary border-bottom mr-1" onClick={this.saveGroup}> Save </button>
          ...
          <Modal isOpen={isAssignRole} className="react-strap-modal-container">
            <ModalHeader>Assign Roles To Group</ModalHeader>
            <ModalBody className="modal-content">
              <form className="gf-form-group section m-0 dflex">
                <div className="modal-fwidth">
                  {
                  ...
                  <div className="m-t-1 text-center">
                    <button type="button" onClick={this.assignRoles} disabled={selectedGroup === null ? true : false } className="btn btn-primary border-bottom mr-1"> Save </button>
