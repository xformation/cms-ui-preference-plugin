...
class LegalEntities extends React.Component<any, any> {
  ...
  render() {
    const {logoSrc, isModalOpen, isModalOpen1, states, cities, selectedState, selectedCity, activeTab } = this.state;
    return (
      <div className="info-container">
        <div className="logo-container d-flex m-b-1">
        ...
        <div className="signatory-list">
          <div className="tile m-r-2 mt-0">
            <div className="legal-entities-tile-circle yellow">
              <b>1</b>
            </div>
            <div className="legal-entities-tile-right-part">
              <div className="legal-entities-tile-name">
        ...
        <div className="signatory-list">
          <div className="tile m-r-2 mt-0">
            <div className="legal-entities-tile-circle SBI">
              <b>&#8377;</b>
            </div>
            <div className="legal-entities-tile-right-part">
              <div className="legal-entities-tile-name">
            ...
            <form className="gf-form-group section m-0 dflex">
              <div className="modal-fwidth">
                ...
                <div className="m-t-1 text-center">
                  ...
                  <button type="submit" className="btn btn-success border-bottom mr-1"> Update </button>
        ...
        <div className="clearfix" />
        <div className="dflex m-b-1 algn-item-center m-t-1">
...
export default withApollo(LegalEntities);
