...
const ERROR_MESSAGE_SERVER_SIDE_ERROR =
  'Due to some error in preference service, master data could not be uploaded. Please check preference service logs';
  ...
  validateFields(obj: any) {
    ...
    if (obj.entityId === undefined || obj.entityId === null || obj.entityId === '') {
      commonFunctions.changeTextBoxBorderToError(
        obj.entityId === undefined || obj.entityId === null ? '' : obj.entityId,
        'entityId'
      );
        ...
        <div className="page-container page-body legal-entities-main-container">
          <div className="authorized-signatory-container m-b-1">
            ...
            <div className="importDflex">
              <div className="rtMargin" id="impt-style">
          ...
          <button onClick={this.uploadFile} className="btn btn-primary">
            Upload
          </button>
          {isLoading ? (
