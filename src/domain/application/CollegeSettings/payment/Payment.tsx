                ...
                <div className="page-container page-body legal-entities-main-container">
                    ...
                    <div className="p-flex">
                        <form name="paymentForm" className="gf-form-group section m-b-1">
                            <input type="number" placeholder="Enter amount" id="pmt" required ng-model="pmt.amount" />
                            <input className="btn btn-primary cust-h-w" type="button" id="btnPay" value="Pay" ng-click="doPayment()" />
                        </form>
