  ...
  render() {
    return (
      <div className="info-container">
        ...
        <button ng-click="uploadFile()" className="uploadbtn">
          <i className="fa fa-cloud-upload imclod" aria-hidden="true" />
          <span>Upload</span>
        </button>
      </div>
    );
