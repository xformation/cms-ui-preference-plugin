...
const SUCCESS_MESSAGE_ADMISSION_ENQUIRY_ADDED =
  'New admission enquiry saved successfully';
const SUCCESS_MESSAGE_ADMISSION_ENQUIRY_UPDATED =
...
export class StaffSetup extends React.Component<any, any> {
  ...
  create() {
    ...
    savebtns.setAttribute('class', 'btn btn-primary m-r-1');
  }
  back() {
    let {count, countParticularDiv} = this.state;
    countParticularDiv = 0;
  ...
  render() {
    const {isModalOpen, activeTab, staffData} = this.state;
    return (
      <div className="info-container">
        <div className="authorized-signatory-container m-b-1">
          <h3>Staff Setup</h3>
          {/* error message */}
          {staffData.errorMessage !== '' ? (
            <MessageBox message={staffData.errorMessage} activeTab={2} />
          ) : null}
          {staffData.successMessage !== '' ? (
            <MessageBox message={staffData.successMessage} activeTab={1} />
          ) : null}
        </div>
        ...
        <div id="lidiv" className="p-1 page-body legal-entities-main-container">
          <div className="staff-management">
            ...
            <a className="btn btn-primary m-l-1" id="fileType">
              Export
            </a>
          </div>
